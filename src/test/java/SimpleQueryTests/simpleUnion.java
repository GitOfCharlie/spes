...
public class simpleUnion {
    public static void main(String[] args) throws  Exception{
        ...
        RelNode newNode = parser.getRelNode("SELECT * FROM EMP UNION ALL SELECT * FROM DEPT");
        ...
        RelNode newNode2 = parser2.getRelNode("SELECT * FROM EMP UNION ALL SELECT * FROM DEPT");
